      			...
      			var html;
       			$.getJSON(url, function(data) {
       				...
       				for(var i = 0; i < data.data.length; i++) {
       						...
       						rndclr=random_color();
       						html = "<div><a href=\"javascript:getEventPage('"+data.data[i].id+"')\"><div class=\"event-wrapper\"><div class=\"event-image\"><img src=\"@{picture}\" class=\"evt-img\"/></div><div class=\"event-text\"><p class=\"event-name\">@{name}</p><p class=\"event-date\">@{time}</p></div></div></a></div>";
